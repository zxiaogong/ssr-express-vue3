...
class Index extends Service {
    async post(query): Promise<any> {
        try {
            const resulte = await this.mysql().addSql({
                table_name: "user_list",
                value: {
                    user_id: this.randomNum(2147483647, 1),
